...
export type StorageHash =
  StorageHashBase<'45ea66c3b071af7c93a58b736bc53cf1b8a5c50957d5af6df8b3b647ac56c692'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly InventoryItem: {
      ...
      readonly additionalImageUrls: CodecTypes['pg/text@1']['output'] | null;
      readonly quantity: CodecTypes['pg/float8@1']['output'];
      readonly unit: CodecTypes['pg/text@1']['output'];
      readonly expiryDate: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly expiryType: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly User: {
      ...
      readonly plan:
        'consumer_free' | 'consumer_plus' | 'business_starter' | 'business_pro' | 'business_growth';
      readonly businessId: CodecTypes['pg/int4@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly InventoryItem: {
      ...
      readonly additionalImageUrls: CodecTypes['pg/text@1']['input'] | null;
      readonly quantity: CodecTypes['pg/float8@1']['input'];
      readonly unit: CodecTypes['pg/text@1']['input'];
      readonly expiryDate: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly expiryType: CodecTypes['pg/text@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly inventoryActivity: {
              ...
              indexes: readonly [
                {
                  readonly name: 'inventoryActivity_userId_idx_a489d58a';
                  readonly prefix: 'inventoryActivity_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'inventoryActivity_businessId_idx_ae0ed511';
                  readonly prefix: 'inventoryActivity_businessId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'inventoryActivity';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly inventoryConsumption: {
              columns: {
                ...
                readonly normalizedQuantityUsed: {
                  readonly nativeType: 'float8';
                  readonly codecId: 'pg/float8@1';
                  readonly nullable: true;
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'inventoryConsumption_userId_idx_a489d58a';
                  readonly prefix: 'inventoryConsumption_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'inventoryConsumption_businessId_idx_ae0ed511';
                  readonly prefix: 'inventoryConsumption_businessId_idx';
                  readonly columns: readonly ['businessId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'inventoryConsumption';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly user: {
              columns: {
                ...
                readonly plan: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'consumer_free'>;
                  };
                };
                readonly businessId: {
                  readonly nativeType: 'int4';
...
> & {
  ...
  readonly roots: {
    ...
    readonly inventoryConsumption: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'InventoryConsumption';
    };
    readonly inventoryActivity: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'InventoryActivity';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly InventoryActivity: {
            ...
            readonly storage: {
              readonly table: 'inventoryActivity';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
          ...
          readonly InventoryConsumption: {
            ...
            readonly storage: {
              readonly table: 'inventoryConsumption';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                ...
                readonly unit: { readonly column: 'unit' };
                readonly normalizedQuantityUsed: { readonly column: 'normalizedQuantityUsed' };
          ...
          readonly InventoryItem: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly additionalImageUrls: { readonly column: 'additionalImageUrls' };
                readonly quantity: { readonly column: 'quantity' };
                readonly unit: { readonly column: 'unit' };
                readonly expiryDate: { readonly column: 'expiryDate' };
                readonly expiryType: { readonly column: 'expiryType' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          ...
          readonly UserPlan: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'CONSUMER_FREE'; readonly value: 'consumer_free' },
              { readonly name: 'CONSUMER_PLUS'; readonly value: 'consumer_plus' },
              { readonly name: 'BUSINESS_STARTER'; readonly value: 'business_starter' },
              { readonly name: 'BUSINESS_PRO'; readonly value: 'business_pro' },
              { readonly name: 'BUSINESS_GROWTH'; readonly value: 'business_growth' },
            ];
          };
        };
      };
