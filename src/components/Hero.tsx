...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-[var(--sl-color-border)] bg-[var(--sl-color-canvas)] px-6 pb-16 pt-12 md:pb-24 md:pt-20">
      ...
      {/* Soft dark forest backdrop behind hero headline and CTAs for effortless readability against the video */}
      <div className="pointer-events-none absolute -left-20 top-6 -z-10 h-[520px] w-[580px] rounded-full bg-[#0c120e]/65 blur-3xl opacity-90" />
      <div className="pointer-events-none absolute -right-20 top-6 -z-10 h-[520px] w-[580px] rounded-full bg-[#0c120e]/65 blur-3xl opacity-90" />
