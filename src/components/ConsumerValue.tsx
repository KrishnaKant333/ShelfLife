          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
            {features.slice(1).map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="rounded-[var(--sl-radius-lg)] border border-[var(--sl-color-border)] bg-[var(--sl-color-canvas)] p-6 transition hover:-translate-y-1 hover:shadow-[var(--sl-shadow-md)]"
                >
