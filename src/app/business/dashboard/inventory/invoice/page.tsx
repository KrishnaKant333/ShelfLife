...
export default function BusinessInvoiceImportPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 sm:px-6 md:px-0 py-6 md:py-10">
      <div className="mb-6 md:mb-8">
        ...
        <p className="mt-1.5 text-sm text-[var(--app-text-muted)]">
          Upload commercial supplier invoices or delivery manifests to automatically extract and register bulk inventory.
        </p>
      </div>
