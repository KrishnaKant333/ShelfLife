export default function BusinessAlertsLoading() {
  return (
    <div className="p-6 md:p-8 space-y-6 animate-pulse">
      ...
      <div className="space-y-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-[var(--shelf-border)] bg-[var(--shelf-surface)] p-5 h-20 flex items-center gap-4">
